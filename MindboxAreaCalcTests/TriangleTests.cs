...
namespace MindboxAreaCalc.Tests
{
    ...
    public class TriangleTests
    {
        ...
        {
            IFigure t1 = Figure.Construct(Triangle.Type(), 1, 1, DecimalMath.SqrtDecimal(2));
        ...
        {
            IFigure t1 = Figure.Construct(Triangle.Type(), 1, 1, 1);
        ...
        {
            IFigure t1 = Figure.Construct(Triangle.Type(), 3, 4, 5);
        ...
        {
            IFigure t1 = Figure.Construct(Triangle.Type(), 1, 1, 1.5);
        ...
        {
            IFigure t1 = Figure.Construct(Triangle.Type(), 1E27m, 1E27m, 1E27m);
            bool overflow = false; 
